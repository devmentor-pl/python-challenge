...
Poniżej przedstawiam 10 zadań, które kursanci powinni rozwiązać w celu opanowania podstaw programowania w Pythonie oraz podstaw programowania obiektowego. 

Każde zadanie zawiera krótki opis oraz informację, jakie umiejętności kursant będzie mógł sprawdzić i rozwijać podczas jego realizacji. 
...
### :point_right: &nbsp; [`#01`](./01) &nbsp; [`#02`](./02) &nbsp; [`#03`](./03) &nbsp; [`#04`](./04) &nbsp; [`#05`](./05) &nbsp; [`#06`](./06) &nbsp; [`#07`](./07) &nbsp; [`#08`](./08) &nbsp; [`#09`](./09) &nbsp; [`#10`](./05) &nbsp; :point_left:	
